...
You can package {%= productName %} by running the following commands based on your target system:
...
{%= productName %} is built with [Angular 2](https://angular.io/) using Typescript. The main application starts in `app/app.ts`.
